...
namespace Inforigami.Regalo.Core
{
    public static class Resolver
    {
        ...
        internal static object Resolve(Type type)
        {
            ...
            {
                throw new InvalidOperationException("Resolvers have not been set. Be sure to call Inforigami.Regalo.Core.Resolver.SetResolvers() in your application initialisation.");
            }
