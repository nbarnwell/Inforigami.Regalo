...
{
    public class MessageHandlerContextSession<TEntity> : IMessageHandlerContextSession<TEntity>
        where TEntity : AggregateRoot, new()
    {
        ...
        public MessageHandlerContextSession(IRepository<TEntity> repository, IEventBus eventBus, IMessage currentMessage)
        {
